...
public abstract class SparqlQueries {
	...
	// TODO: Integrate named graph or use default
	...
	public final static String CONCEPTS = "SELECT DISTINCT ?concept" + GRAPH
			+ "WHERE {[] a ?concept} ORDER BY ?concept";
	...
	public final static String RANDOM_DATASETS = "SELECT DISTINCT ?dataset" + GRAPH
			+ "WHERE { ?dataset a <http://www.w3.org/ns/dcat#Dataset> } ORDER BY RAND() LIMIT 10";
