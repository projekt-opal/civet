...
public class DescriptionMetricTest {
	...
	public void test() {
		...
		data.setDataObject(new StringDataObject(DataObjects.TITLE, "test"));
		data.setDataObject(new StringDataObject(DataObjects.DESCRIPTION, ""));
		assertEquals(1, new DescriptionMetric().getScore(data), 0);

		data = new DataContainer();
		data.setDataObject(new StringDataObject(DataObjects.TITLE, ""));
		data.setDataObject(new StringDataObject(DataObjects.DESCRIPTION, "test"));
		assertEquals(1, new DescriptionMetric().getScore(data), 0);
		...
		data = new DataContainer();
		data.setDataObject(new StringDataObject(DataObjects.TITLE, "test"));
		data.setDataObject(new StringDataObject(DataObjects.DESCRIPTION, "this is a description: 25"));
